...
(note4: Κυριακή 14/05 - 17:10 - Προσπάθησα και εβαλα glb αρχείο για το Οξυγόνο και έπαιξε αλλά αργεί να ανοίξει και είναι με λάθος προσανατολισμό)
      ...
      :interrobang: Έφτιαξα τον προσανατολισμό αλλα δεν κατάφερα να παίξει το animation, απλά μου εμφανίζει τον κύβο μου. Επίσης καταλαθος πείραξα το          αρχικό index.html αλλα νομίζω το διόρθωσα.
